        ...
        <article className='w-full flex items-center justify-between rounded-3xl border border-solid border-dark bg-light shadow-2xl p-12 relative rounded-br-2xl'>
            ...
            <div className='w-1/2 flex flex-col items-start justify-between pl-6'>
                ...
                <div className='mt-2 flex items-center'>
                    <FramerLink href={github} target='_blank' className='w-10' whileHover={{scale:1.03}} transition={{duration:0.2}}><GithubIcon /></FramerLink>
                    <FramerLink href={link} target='_blank' className='ml-4 rounded-lg bg-dark text-light p-2 px-6 text-lg font-semibold' whileHover={{scale:1.03}} transition={{duration:0.2}}>Visit Project</FramerLink>
                </div>
            </div>
        ...
        <article className='w-full flex flex-col items-center justify-center rounded-2xl border border-solid border-dark bg-light p-6 relative'>
            ...
            <div className='w-full flex flex-col items-start justify-between mt-4'>
                ...
                <div className='w-full mt-2 flex items-center justify-between'>
                    ...
                    <FramerLink href={github} target='_blank' className='w-8' whileHover={{scale:1.03}} transition={{duration:0.2}}><GithubIcon /></FramerLink>
                </div>
            </div>
        </article>
    )
...
const projects = () => {
  return (
    <>
        <Head>
            <title>David Irén | Projects Page</title>
