...
const FeaturedProject = ({type, title, summary, img, link, github}) => {
    return(
        ...
        shadow-2xl p-12 relative rounded-br-2xl dark:bg-dark dark:border-light'>
            ...
            <div className='w-1/2 flex flex-col items-start justify-between pl-6'>
                ...
                <div className='mt-2 flex items-center'>
                    ...
                    <FramerLink href={link} target='_blank' className='ml-4 rounded-lg bg-dark text-light p-2 px-6 text-lg font-semibold dark:bg-light dark:text-dark' 
                    whileHover={{scale:1.03}} 
                    transition={{duration:0.2}}>
                        Visit Project
                    </FramerLink>
