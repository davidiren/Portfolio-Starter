...
const CustomMobileLink = ({href, title, className="", toggle}) => {
    ...
    return(
        <button href={href} className={`${className} relative group text-light dark:text-dark my-2`} onClick={handleClick}>
            ...
            <span className={`h-[1px] inline-block bg-light dark:bg-dark absolute left-0 -bottom-0.5 group-hover:w-full 
                transition-[width] ease duration-300 ${router.asPath == href ? 'w-full' : 'w-0'} dark:bg-light`}>
                &nbsp;
            </span>
        </button>
  ...
  return (
    ...
    >
        ...
        <nav className='flex items-center justify-center flex-wrap'>
            ...
            <motion.a href={"/"} target='_blank' whileHover={{y:-2}} whileTap={{scale:0.9}} className='w-6 mr-3 bg-light rounded-full'>
                <PinterestIcon/>
            </motion.a>
            <motion.a href={"/"} target='_blank' whileHover={{y:-2}} whileTap={{scale:0.9}} className='w-6 mr-3'>
                <DribbbleIcon/>
        ...
        bg-dark/80 dark:bg-light/75 rounded-lg backdrop-blur-md py-32'
        >
        ...
        <nav className='flex items-center justify-center flex-wrap mt-2 '>
            ...
            <motion.a href={"/"} target='_blank' whileHover={{y:-2}} whileTap={{scale:0.9}} className='w-6 mr-3 sm:mx-1 bg-light dark:bg-dark rounded-full'>
                <GithubIcon/>
            </motion.a>
            <motion.a href={"/"} target='_blank' whileHover={{y:-2}} whileTap={{scale:0.9}} className='w-6 mr-3 sm:mx-1'>
                <LinkedInIcon/>
            </motion.a>
            <motion.a href={"/"} target='_blank' whileHover={{y:-2}} whileTap={{scale:0.9}} className='w-6 mr-3 sm:mx-1 bg-light rounded-full'>
                <PinterestIcon/>
            </motion.a>
            <motion.a href={"/"} target='_blank' whileHover={{y:-2}} whileTap={{scale:0.9}} className='w-6 mr-3 sm:mx-1'>
                <DribbbleIcon/>
